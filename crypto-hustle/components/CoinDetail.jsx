            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{fullDetails.numbers[params.symbol].USD.OPENDAY || "N/A"}</td>
                    </tr>
                    <tr>
                        <th>Highest Price during the Day</th>
                        <td>{fullDetails.numbers[params.symbol].USD.HIGHDAY || "N/A"}</td>
                    </tr>
                    <tr>
                        <th>Lowest Price during the Day</th>
                        <td>{fullDetails.numbers[params.symbol].USD.LOWDAY || "N/A"}</td>
                    </tr>
                    <tr>
                        <th>Change from Previous Day</th>
                        <td>{fullDetails.numbers[params.symbol].USD.CHANGEPCT24HOUR || "N/A"}%</td>
                    </tr>
                    <tr>
                        <th>Market Cap</th>
